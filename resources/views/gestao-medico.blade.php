            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <form class="form-inline mr-auto my-2 my-md-0 me-3" action="{{ route('medicos.search') }}"
                            method="GET">
                                        ...
                                        <div class="row pt-3 pb-3 recepcionista-item">
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex flex-row">
                                                    <button type="button"
                                                        class="btn btn-sm btn-secondary me-2 d-flex justify-content-center align-items-center btnDetalhesMedico"
                                                        data-toggle="modal" data-target="#modalDetalhesMedico"
                                                        data-id="{{ $medico->id }}" title="Exibir Detalhes do Médico">
                                                        <ion-icon name="information-circle-outline"
                                                            class="fs-5"></ion-icon>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-warning me-2 d-flex justify-content-center align-items-center btnEditarMedico"
                                                        data-toggle="modal" data-target="#modalEditarMedico"
                                                        data-id="{{ $medico->id }}" title="Editar Médico">
                                                        <ion-icon name="create-outline" class="fs-5"></ion-icon>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-danger d-flex justify-content-center align-items-center btnExcluirMedico"
                                                        data-toggle="modal" data-target="#modalExcluirMedico"
                                                        data-id="{{ $medico->id }}" title="Excluir Médico">
