                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                ...
                                <div class="col text-primary fw-semibold">CRM/UF</div>
                                <div class="col text-primary fw-semibold">Especialidade(s)</div>
