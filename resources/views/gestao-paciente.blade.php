@php
    $layout = '';
    if (Request::is('painel-adm/gestao-paciente')) {
        $layout = 'layouts.menu-adm';
    } elseif (Request::is('painel-recepcionista/gestao-paciente')) {
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <form id="formPequisaPaciente" class="form-inline mr-auto my-2 my-md-0 me-3" action="/painel-adm/gestao-paciente"
                            method="GET">
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex flex-row">
                                                    <button type="button"
                                                        ...
                                                        data-toggle="tooltip" data-target="#modalDetalhesPaciente"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-toggle="tooltip" data-target="#modalEditarPaciente"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-toggle="tooltip" data-target="#modalExcluirPaciente"
                                ...
                                <nav aria-label="Page navigation example">
                                    <div class="pagination job-pagination mb-0 justify-content-center">
                                        <li class="page-item disabled">
                                            <a class="page-link" tabindex="-1" href="#"><ion-icon
                                                    name="chevron-back-outline"
                                                    class="align-middle font-infos"></ion-icon></a>
                                        </li>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="#"><ion-icon name="chevron-forward-outline"
                                                    class="align-middle font-nome-agenda"></ion-icon></a>
                                        </li>
                                    </div>
                                </nav>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                if (currentUrl === "/painel-recepcionista/gestao-paciente") {
                    $('.btnExcluirPaciente').prop('disabled', true);
                    $('#formNovoPaciente').attr('action', "/paciente/recepcionista/insert");
                    $('#formEditarPaciente').attr('action', '/painel-recepcionista/gestao-paciente');
                }
            });
        </script>
    </div>
