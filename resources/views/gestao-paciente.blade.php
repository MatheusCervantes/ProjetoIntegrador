        ...
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="d-flex align-items-center">
                    <button class="btn btn-light shadow-sm border small me-3 btnList" type="button" data-toggle="tooltip" title="Exibir Lista de Pacientes">
                            ...
                            <div class="row pt-3 pb-3 border-bottom">
                                ...
                                <div class="col-2">
                                    <div class="d-flex flex-row">
                                        <button type="button" class="btn btn-sm btn-secondary me-2 d-flex justify-content-center align-items-center btnDetalhesPaciente" data-toggle="tooltip" title="Exibir Detalhes do Paciente">
                                            <ion-icon name="information-circle-outline" class="fs-5"></ion-icon>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-warning me-2 d-flex justify-content-center align-items-center btnEditarPaciente" data-toggle="tooltip" title="Editar Paciente">
                                            <ion-icon name="create-outline" class="fs-5"></ion-icon>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger d-flex justify-content-center align-items-center btnExcluirPaciente" data-toggle="tooltip" title="Excluir Paciente">
