            ...
            <div class="modal-body m-auto py-4">
                <form id="formEditarMedico">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="especialidades" class="form-label">Especialidades<span class="required-field">*</span></label>
                                <input type="text" class="form-control" id="especialidades" name="especialidades" data-role="tagsinput" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="atuacao" class="form-label">Áreas de Atuação<span class="required-field">*</span></label>
                                <input type="text" class="form-control" id="atuacao" name="atuacao" data-role="tagsinput" required>
                            </div>
                        </div>
                    </div>
                </form>
