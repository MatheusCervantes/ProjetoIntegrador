<div class="modal fade modal-lg" id="modalEditarMedico" tabindex="-1" aria-labelledby="modalEditarMedicoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
                ...
                <form id="formEditarMedico">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="segunda" name="dias-semana-editar" value="segunda">
                                    <label class="form-check-label" for="segunda">Segunda-feira</label>
                                    <div id="segunda-periodos-editar" style="display: none;">
                                        <div class="form-check">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="terca" name="dias-semana-editar" value="terca">
                                    <label class="form-check-label" for="terca">Terça-feira</label>
                                    <div id="terca-periodos-editar" style="display: none;">
                                        <div class="form-check">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="quarta" name="dias-semana-editar" value="quarta">
                                    <label class="form-check-label" for="quarta">Quarta-feira</label>
                                    <div id="quarta-periodos-editar" style="display: none;">
                                        <div class="form-check">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="quinta" name="dias-semana-editar" value="quinta">
                                    <label class="form-check-label" for="quinta">Quinta-feira</label>
                                    <div id="quinta-periodos-editar" style="display: none;">
                                        <div class="form-check">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="sexta" name="dias-semana-editar" value="sexta">
                                    <label class="form-check-label" for="sexta">Sexta-feira</label>
                                    <div id="sexta-periodos-editar" style="display: none;">
                                        <div class="form-check">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="sabado" name="dias-semana-editar" value="sabado">
                                    <label class="form-check-label" for="sabado">Sábado</label>
                                    <div id="sabado-periodos-editar" style="display: none;">
                                        <div class="form-check">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="domingo" name="dias-semana-editar" value="domingo">
                                    <label class="form-check-label" for="domingo">Domingo</label>
                                    <div id="domingo-periodos-editar" style="display: none;">
                                        <div class="form-check">
            ...
            <div class="modal-footer bg-body-tertiary">
                ...
                <button type="button" class="btn btn-primary" id="btnSalvarEdicaoMedico">Salvar Alterações</button>
            </div>
        </div>
    </div>
</div>