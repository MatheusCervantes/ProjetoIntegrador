<div class="modal fade modal-lg" id="modalNovoPaciente" tabindex="-1" aria-labelledby="modalNovoPacienteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-body-tertiary">
                <div class="d-flex justify-content-center align-items-center flex-grow-1">
                    <h4 class="modal-title fw-bold text-primary ms-4" id="modalNovoPacienteLabel">Novo Paciente</h4>
                </div>
            ...
            <div class="modal-body m-auto py-4">
                <form id="formNovoPaciente">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="condicao-medica" class="form-label">Condição Médica Atual</label>
                                <textarea class="form-control" id="condicao-medica" name="condicao-medica" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="doencas-ant" name="doencas-ant" placeholder="Opcional"></textarea>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label for="doencas-hered" class="form-label">Doenças Hereditárias</label>
                                <textarea class="form-control" id="doencas-hered" name="doencas-hered" placeholder="Opcional"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div id="info-plano-saude-novo" style="display: none;">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
