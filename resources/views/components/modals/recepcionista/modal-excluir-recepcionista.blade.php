<div class="modal fade modal-md" data-bs-backdrop="static" data-bs-keyboard="false" id="modalExcluirRecepcionista" tabindex="-1"
        ...
        <div class="modal-content">
            <form id="formExcluirRecepcionista" method="POST" data-action="/painel-adm/gestao-recepcionista/delete/">
                ...
                <div class="modal-body m-auto py-4 text-center">
                    Tem certeza que deseja excluir este recepcionista?
                </div>
