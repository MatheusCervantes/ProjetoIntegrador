        ...
        <div class="modal-content">
            <div class="modal-header bg-body-tertiary">
                <div class="d-flex justify-content-center align-items-center flex-grow-1">
                    <h4 class="modal-title fw-bold text-primary ms-4" id="modalEditarFinanceiroLabel">Editar Movimentação Financeira</h4>
                </div>
                        ...
                        <div class="col-auto">
                            <div class="mb-3 mt-4 pt-1">
                                <div class="form-check-inline">
                                    <input class="form-check-input me-1" type="checkbox" name="tipo-despesa" id="despesa-fixa-editar" value="fixa">
            ...
            <div class="modal-footer bg-body-tertiary">
                ...
                <button type="button" class="btn btn-primary" id="btnSalvarEdicaoFinanceiro">Salvar Alterações</button>
            </div>
        </div>
    </div>
</div>