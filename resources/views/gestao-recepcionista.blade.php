            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <form class="form-inline mr-auto my-2 my-md-0 me-3" action="{{ route('recepcionistas.search') }}"
                            method="GET">
                                        ...
                                        <div class="row pt-3 pb-3 recepcionista-item">
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex flex-row">
                                                    <button type="button"
                                                        class="btn btn-sm btn-secondary me-2 d-flex justify-content-center align-items-center btnDetalhesRecepcionista"
                                                        data-toggle="modal" data-target="#modalDetalhesRecepcionista"
                                                        data-id="{{ $recepcionista->id }}"
                                                        title="Exibir Detalhes do Recepcionista">
                                                        <ion-icon name="information-circle-outline"
                                                            class="fs-5"></ion-icon>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-warning me-2 d-flex justify-content-center align-items-center btnEditarRecepcionista"
                                                        data-toggle="modal" data-target="#modalEditarRecepcionista"
                                                        data-id="{{ $recepcionista->id }}" title="Editar Recepcionista">
                                                        <ion-icon name="create-outline" class="fs-5"></ion-icon>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-danger d-flex justify-content-center align-items-center btnExcluirRecepcionista"
                                                        data-toggle="modal" data-target="#modalExcluirRecepcionista"
                                                        data-id="{{ $recepcionista->id }}" title="Excluir Recepcionista">
