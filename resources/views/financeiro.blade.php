                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4 hscroll">
                            <div class="d-flex align-items-center">
                                <button type="button" class="btn btn-primary shadow-sm btnNovoFinanceiro"
                                    data-toggle="tooltip" title="Adicionar Movimentação Financeira">
                                    <div class="d-flex align-items-center">
                            ...
                            <form method="GET" action="{{ route('financeiro.search') }}">
                                <div class="d-flex align-items-center">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="checkbox" id="filtro-despesa-fixa"
                                            name="filtro-despesa-fixa" value="fixa" disabled>
                                        <label class="form-check-label" for="filtro-despesa-fixa">Despesa Fixa</label>
                                    </div>
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="filtro_movimentacao"
                                            id="filtro-entrada" value="entrada">
                                        <label class="form-check-label" for="filtro-entrada">Entrada</label>
                                    </div>
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="filtro_movimentacao"
                                            id="filtro-saida" value="saida">
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body py-0 ps-3 dados border-bottom hscroll">
                                    @if ($financeiro->count() > 0)
                                        @foreach ($financeiro as $item)
                                            @if ($item->movimentacao == 'Entrada')
                                                <div class="row pt-3 pb-3 border-bottom border-left-success">
                                                    ...
                                                    <div class="col-2">
                                                        <button
                                                            class="btn btn-light shadow-sm border small ms-2 btnDetalhesFinanceiro"
                                                            type="button"
                                                            title="Exibir Detalhes da Movimentação Financeira"
                                                            data-toggle="modal" data-target="#modalDetalhesFinanceiro"
                                                            data-id="{{ $item->id }}">
                                                    ...
                                                    <div class="col-2">
                                                        <div class="d-flex align-items-center">
                                                            <ion-icon name="arrow-forward-circle-outline"
                                                                class="fs-4 me-2 text-success"></ion-icon>
                                                            <div>Entrada</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                    ...
                                                    <div class="col-2">
                                                        <div class="d-flex flex-row">
                                                            <button type="button"
                                                                class="btn btn-sm btn-warning me-2 d-flex justify-content-center align-items-center btnEditarFinanceiro"
                                                                data-toggle="modal" data-target="#modalEditarFinanceiro"
                                                                data-id="{{ $item->id }}"
                                                                title="Editar Movimentação Financeira">
                                                                <ion-icon name="create-outline" class="fs-5"></ion-icon>
                                                            </button>
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger d-flex justify-content-center align-items-center btnExcluirFinanceiro"
                                                                data-toggle="modal" data-target="#modalExcluirFinanceiro"
                                                                data-id="{{ $item->id }}"
                                                    ...
                                                    <div class="col-2">
                                                        <div class="d-flex align-items-center">
                                                            <ion-icon name="arrow-back-circle-outline"
                                                                class="fs-4 me-2 text-danger"></ion-icon>
                                                            <div>Saída</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                        ...
                                        @endforeach
                                    @else
                                        <p class="text-center text-muted my-4">Nenhuma movimentação financeira cadastrada.
                                        </p>
                                    @endif
                                </div>
                            </div>
